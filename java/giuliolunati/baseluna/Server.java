...
import giuliolunati.baseluna.ForegroundService;
import giuliolunati.baseluna.NotificationIdFactory;
...
public class Server extends ForegroundService {
  ...
  protected Notification createNotification() {
    ...
    mBuilder.setContentTitle("BaseLuna Server");
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    String mPort = mPreferences.getString("port", "8000");
    String basepath = this.getFilesDir().getAbsolutePath();
    String[] cmds = {
      basepath + "/system/gatling"
      , "-FSL"
      , "-p" , mPort
    };
